...
import { CloudUpload, FileText, Upload, Sparkles, Loader2 } from 'lucide-react';
                    ...
                    <AnimatePresence mode="wait">
                        {activeTab === 'upload' ? (
                            <motion.div
                                ...
                                className="space-y-6"
                            >
                                <div className="border-2 border-dashed border-gray-200 rounded-2xl p-12 text-center transition-colors hover:border-primary/50 group cursor-pointer bg-gray-50/30">
                                    ...
                                    <h3 className="text-lg font-bold text-gray-900 mb-2">Drag & drop your document here</h3>
                                    <p className="text-gray-400 mb-6">or click to browse your files</p>
                                    <button className="btn-primary">Choose File</button>
                                    <p className="text-xs text-gray-400 mt-6 mt-8">Supported formats: PDF, DOCX, TXT (Max 10MB)</p>
                                </div>
                            </motion.div>
                        ) : (
                            <motion.div
