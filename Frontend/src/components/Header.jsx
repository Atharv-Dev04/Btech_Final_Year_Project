...
export default function Header({ onNavigate, currentPage, onLogout }) {
      ...
      <nav className="flex items-center gap-8">
        <div className="hidden md:flex items-center gap-6 mr-4">
          <button
            ...
            className={`text-sm font-semibold transition-colors ${currentPage === 'home' ? 'text-primary' : 'text-gray-500 hover:text-gray-900'}`}
          >
            Home
          </button>
          <button
            onClick={() => onNavigate('analyze')}
            className={`text-sm font-semibold transition-colors ${currentPage === 'analyze' ? 'text-primary' : 'text-gray-500 hover:text-gray-900'}`}
          >
            Analyze
          </button>
          <button
            onClick={() => onNavigate('news')}
            className={`text-sm font-semibold transition-colors ${currentPage === 'news' ? 'text-primary' : 'text-gray-500 hover:text-gray-900'}`}
          >
            News Feed
          </button>
          <button
            onClick={() => onNavigate('about')}
            className={`text-sm font-semibold transition-colors ${currentPage === 'about' ? 'text-primary' : 'text-gray-500 hover:text-gray-900'}`}
          >
            About
          </button>
        </div>
